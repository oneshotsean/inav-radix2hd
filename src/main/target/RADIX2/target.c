...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3,  CH4, PB1,  TIM_USE_OUTPUT_AUTO, 0, 0),  // S7
    DEF_TIM(TIM4,  CH1, PB6,  TIM_USE_OUTPUT_AUTO, 0, 0),  // S8 (shared I2C1_SCL - verify)
    DEF_TIM(TIM2,  CH2, PA1,  TIM_USE_ANY,         0, 0),  // Camera Control
};

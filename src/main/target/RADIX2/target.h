...
// BrainFPV RADIX 2 (non-HD) - STM32F765 based
// This is the standard-definition sibling of the RADIX2HD.
// NOTE: Verify pin assignments against hardware schematic before flashing.
...
#define BMI270_CS_PIN           PB0

// *************** SPI2 - OSD (MAX7456) **************
// The RADIX2 standard version uses analog OSD via MAX7456
